...
| 05  | [**.NET Generative App Samples (Vibe Coding Prompts)**](./05-GenerativeAppSamples/readme.md) | <ul><li>Sample .NET apps generated using Generative AI tools like GitHub Copilot Agent.</li><li>First sample: SpaceAINet console app.</li><li>See more and move to the last lesson for Responsible GenAI.</li></ul> |
